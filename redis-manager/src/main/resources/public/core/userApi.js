 ...
 */
function  countTotalAlarm(clusterId,callback){
   ajax.async_post("/alarm/countTotal",clusterId,callback);
}
/**
 * @type GET 
 * @param  String
...
/**
 * @type POST 
 * @param  com.newegg.ec.cache.app.model.RedisQueryParam@38d08cb5
 */

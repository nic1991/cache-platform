   /* var demo= [
    ...
    function home(){
        $("#hrefUl").empty();
        var homeTab = $("<li ><a  style=\"text-decoration:none\" href=\"javascript:home()\">home</a></li>");
        ...
        for(var i=0;i<menu.length;i++){
           if(menu[i].id==menuId){
              $("#hrefUl").empty();
               var homeTab = $("<li ><a  style=\"text-decoration:none\" href=\"javascript:home()\">home</a></li>");
               $("#hrefUl").append(homeTab);
               var tmpTab = $("<li ><a  style=\"text-decoration:none\" href=\"javascript:loadUrl('" + menu[i].id + "')\">" + menu[i].name + "</a></li>");
         ...
         $("#menu_switch").click(function(event){
               if($("#menuBlock").width()==50){
                   $("#menuBlock").animate({"width":"200px"},300,function(){
                        $("#home").html("Newegg * <span style=\"color:white\">Base</span>");
                        $(".menu_item_name").show();
                        $(".subMenuFlag").show();
                   ...
                   $("#home").html("<span style=\"color:white\">Base</span>");
                   $(".menu_item_name").hide();
                   $(".subMenuFlag").hide();
